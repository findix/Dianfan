		...
		<div class="jumbotron">
			...
			<p>
				<a class="btn btn-primary btn-large"
					...
					href="login?type=signup&status=normal">立即注册</a>
			</p>
		</div>
	</div>
	<%
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="videoModalLabel">通过照片获得推荐</h4>
				</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<img src="./images/3001_131012153636_1.jpg" alt="三角烤饼">
							<div class="caption">
								<h3>三角烤饼</h3>
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<img src="./images/1008160361.jpg" alt="四川麻辣烫">
							<div class="caption">
								<h3>四川麻辣烫</h3>
								<p>
